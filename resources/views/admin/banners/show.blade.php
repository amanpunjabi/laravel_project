                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> Title </th><td> {{ $banner->title }} </td></tr><tr><th> Content </th><td> {{ $banner->content }} </td></tr><tr><th> Image </th><td> <img src="{{ asset('storage/'.$banner->image) }}" height="100px" width="100px" style="margin: 0px"></td></tr>
                                </tbody>
                            </table>
                        </div>
