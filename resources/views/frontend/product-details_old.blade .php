							...
							<div class="product-information"><!--/product-information-->
								...
								<span>
									...
									<div class="col-xs-6	">
										...
										{{ get_attribute_value($value['attribute_value_id']) }}</option>
										@endforeach
									    </select>
									</div>

									<input type="hidden" name="variation_id" value="{{ $product->variant->id ?? ''}}">
							</div>
										<span>US $
											{{ $product->variant->price ?? $product->price }}</span>
									<label>Quantity:</label>
									<input type="number" value="1" name="quantity" id="quantity" max="{{ $product->variant->quantity ?? ''}}" />
									...
									<button type="submit" class="btn btn-fefault cart" id="add_cart">
										...
										Add to cart
			                                        ...
			                                        <input type="hidden" value="{{ $product->variant->price ?? $product->price }}" id="price" name="price">
